...
import '../Styles/Header_lg.scss'
import '../Styles/Header_md.scss'
...
function Header() {
    return (
        <header>
            ...
            <div id="poly4"><svg xmlns="http://www.w3.org/2000/svg" width="162.861" height="169.083" viewBox="0 0 162.861 169.083">
                <g id="Polygon_4" data-name="Polygon 4" transform="translate(162.861 56.5) rotate(120)" fill="#fff">
                    <path d="M 129.1355743408203 112.5 L 0.8644299507141113 112.5 L 65 1.002778172492981 L 129.1355743408203 112.5 Z" stroke="none" />
                    <path d="M 65 2.005546569824219 L 1.728851318359375 112 L 128.2711486816406 112 L 65 2.005546569824219 M 65 0 L 130 113 L 0 113 L 65 0 Z" stroke="none" fill="#707070" />
                </g>
            </svg>
...
function Face() {
    return (
        <div id="face-wrapper">
            <svg id="face" xmlns="http://www.w3.org/2000/svg" width="686.566" height="907.815" viewBox="0 0 686.566 907.815">
                <g id="Me_wpap">
...
function Curtain() {
    return (
        <div id="curtain-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="1918.236" height="955.12" viewBox="0 0 1918.236 955.12">
                <path id="curtain" d="M0,873.871l326.486,199.365,1590.75-199.365V119.133H0Z" transform="translate(0.5 -118.633)" fill="#0b3150" stroke="#707070" stroke-width="1" />
            </svg>
        </div>
    )
}
        ...
        <div id="nameIntro-wrapper">
            <svg id="nameIntro" xmlns="http://www.w3.org/2000/svg" width="432" height="456" viewBox="0 0 480 456">
                ...
                <g id="Group_4" data-name="Group 4" transform="translate(88)">
                    <text id="HI" transform="translate(0 150)" fill="#fae3ad" font-size="150"><tspan x="0" y="0">HI</tspan></text>
                    <text id="I_M" data-name="I&apos;M" transform="translate(110.5 251)" fill="#fae3ad" font-size="150" ><tspan x="0" y="0">I&apos;M</tspan></text>
                </g>
            </svg>
        </div>
    )
...
function IntroText() {
    return (
        <div id="introText-wrapper">
            <p>
            When I am not coding or designing,<br />
            I like learning about new technologies, Playing Chess and  Playing Keyboard.<br />
            <br />
            If you want someone in your team who is trustworthy and dedicated towards his work,<br/>
            then your search has finally ended. 
            Scroll down to checkout my resume below.
            </p>
        </div>
    )
}